...
pub type StratisResult<T> = Result<T, Error>;
...
unsafe impl Send for StratisError {}
unsafe impl Sync for StratisError {}
...
impl error::Error for StratisError {
    fn description(&self) -> &str {
        match *self {
            ...
            StratisError::Udev(ref err) => error::Error::description(err),
        }
    }
